...
class image_scraper:
        ...
        while i < len(keyword_to_search):
            url = 'https://www.google.com/search?q=' + quote(
                keyword_to_search[i].encode(
                    'utf-8')) + '&sxsrf=APq-WBtnAz4YwlnKPSwIwqnnPDqeItJTlQ:1643906549062&source=lnms&tbm=isch&sa=X&ved=2ahUKEwio7pmP_eP1AhUFZd8KHdt3C2AQ_AUoAnoECAEQBA&biw=1920&bih=942&dpr=1'
    ...
    def download(self, keywords, limit, extensions={'.jpg', '.png', '.ico', '.gif', '.jpeg'}, main_directory = "data/"):
        ...
        while i < len(keyword_to_search):
            ...
            url = 'https://www.google.com/search?q=' + quote(
                keyword_to_search[i].encode('utf-8')) + '&sxsrf=APq-WBtnAz4YwlnKPSwIwqnnPDqeItJTlQ:1643906549062&source=lnms&tbm=isch&sa=X&ved=2ahUKEwio7pmP_eP1AhUFZd8KHdt3C2AQ_AUoAnoECAEQBA&biw=1920&bih=942&dpr=1'
            raw_html = self._download_page(url)
